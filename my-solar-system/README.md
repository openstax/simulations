...
3. From the root `my-solar-system` directory, run `npm install` in the command line to install test and build dependencies.
...
From the root `my-solar-system` directory, run `grunt dist`.

The `dist` directory containing the built site will be added to the root `my-solar-system` directory.

### Testing

To run command-line tests, run `grunt test` from the root `my-solar-system` directory.
