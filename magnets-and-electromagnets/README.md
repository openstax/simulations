...
3. From the root `magnets-and-electromagnets` directory, run `npm install` in the command line to install test and build dependencies.
...
From the root `magnets-and-electromagnets` directory, run `grunt dist`.

The `dist` directory containing the built site will be added to the root `magnets-and-electromagnets` directory.

### Testing

To run command-line tests, run `grunt test` from the root `magnets-and-electromagnets` directory.
...
From the root `magnets-and-electromagnets` directory, run `npm run-script upgrade`, which executes the following commands:
