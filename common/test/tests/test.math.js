...
describe('Matrix', function(){
	...
	it('#rref works', function() {
		...
		var matrix3 = new Matrix([
			[0.00,1.00,0.00,0.00,0.00,0],
			[1.00,0.10,0.00,-0.10,0.00,0],
			[0.00,0.00,0.30,-0.10,-0.20,0],
			[0.00,-0.10,-0.10,0.20,0.00,0],
			[-1.00,0.00,-0.20,0.00,0.20,0],
			[0.00,-1.00,0.00,0.00,1.00,10]
		]);
